  ...
  render() {
    return (
      <div className="App-header">
        ...
        <NavLink to={`/personscrud`} activeClassName="active">
          People
        </NavLink>
        <NavLink to={`/timeoffs`} activeClassName="active">
          Timeoffs
        </NavLink>
        ...
        <NavLink to={`/timelogs`} activeClassName="active">
          Timelogs
        </NavLink>
        <NavLink to={`/projectscrud`} activeClassName="active">
          Projects
        </NavLink>
