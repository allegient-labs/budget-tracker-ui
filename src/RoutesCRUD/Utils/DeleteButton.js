...
class DeleteButton extends React.Component {
  ...
  render(){
    ...
    <Modal trigger={<Button onClick={this.handleOpen} color='red' icon="erase"></Button>}         
      ...
      basic size='small'>
      <Header icon='warning' content={`Are You Sure You Want To Delete ${this.props.thingName}?`} />
      <Modal.Content>
      ...
      <Modal.Actions>
        ...
        <Button color='green' onClick={this.props.deleteF.bind(null, this.props.thing._links.self, this.handleClose)} inverted>
